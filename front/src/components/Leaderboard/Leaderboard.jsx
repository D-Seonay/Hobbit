...
const leaderboardData = [
  { name: "User 1", level: 35, avatar: "/path/to/avatar1.jpg" },
  { name: "User 2", level: 33, avatar: "" },
  { name: "User 3", level: 31, avatar: "/path/to/avatar3.jpg" },
  { name: "User 4", level: 30, avatar: "/path/to/avatar4.jpg" },
  { name: "User 5", level: 29, avatar: "/path/to/avatar5.jpg" },
  { name: "User 6", level: 28, avatar: "/path/to/avatar6.jpg" },
];
...
const UserCard = ({ user, rank }) => (
  <div className="text-center">
    <img
      ...
      className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full mx-auto border-2 border-gray-300 dark:border-gray-500 mb-2"
    />
