...
const Navbar = ({ darkMode, setDarkMode }) => {
	...
	return (
		<nav className="p-4 sticky top-0 z-50 postion-0 flex justify-between items-center h-24">
			<div className="">
				{/* Logo */}
			...
			<div className="mx-auto flex justify-between items-center">
				{/* Menu Normal */}
				<div className="hidden md:flex space-x-6 backdrop-blur-md bg-gray-800 bg-opacity-50 py-4 px-10 rounded-full text-white ">
					...
					<Link to="/profile" className="text-xl hover:text-yellow-500 transition-all duration-300">
						<CgProfile className="inline-block mr-2" /> Profile
					</Link>
				</div>
